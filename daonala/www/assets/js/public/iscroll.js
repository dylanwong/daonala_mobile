...
var mainScroll,historyScroll;
var mainPullDownEl, mainPullDownL,historyPullDownEl, historyPullDownL;
var mainPullUpEl, mainPullUpL,historyPullUpEl, historyPullUpL;
var mainLoadingStep,historyLoadingStep = 0;//加载状态0默认，1显示加载状态，2执行加载数据，只有当为0时才能再次加载，这是防止过快拉动刷新
function mainLoaded() {
